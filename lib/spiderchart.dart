...
class _SpiderChartWidgetState extends State<SpiderChartWidget>
  ...
  void initState() {
    ...
    _scaleAnim =
        new CurvedAnimation(parent: _labelController, curve: Curves.easeInOut);
          ...
          child: Stack(
            children: []
              ...
              ..addAll(List.generate(
                  widget.nbSides, (final int index) => _createLabel(index))),
          ),
        );
      },
    );
          ...
          builder: (context, child) {
            return widget.activeLabel == i
                ? PointerWidget(
                    ...
                    radius: widget.labels[i].roundSize * 4 +
                        (widget.labels[i].roundSize * 2 * _scaleAnim.value),
                  )
                : child!;
          },
          child: LabelWidget(
